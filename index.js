...
function pages(options, callback) {
  ...
  self.serve = function(options) {
    ...
    return function(req, res) {
      ...
      req.extras = {};
      return async.series([time(page, 'page'), time(secondChanceLogin, 'secondChanceLogin'), time(permissions, 'permissions'), time(relatives, 'relatives'), time(load, 'load'), time(notfound, 'notfound'), time(deferredSlideshows, 'deferred slideshows')], main);
